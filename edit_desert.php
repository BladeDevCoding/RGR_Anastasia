...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nazva)) {
        ...
        $result = updateDesert($desert_id, $nazva, $opis, $tsina, $vaha_gram, $dostupnyy, $kategoria);
        ...
        if ($result) {
            ...
            header('Location: view_desert.php?id=' . $desert_id . '&success=1');
            exit;
        } else {
            $error = 'Помилка при оновленні десерту';
        }
    }
} else {
...
<head>
    ...
    <title>Редагувати десерт - KityKoffe</title>
...
<body>
    ...
    <div class="form-container">
        <h1>Редагувати десерт</h1>
        
        <p>
            <a href="view_desert.php?id=<?php echo $desert_id; ?>" class="btn">← Повернутися до деталей</a>
        </p>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <?php if (file_exists('images/deserts/' . $desert_id . '.jpg')): ?>
                    <div>
                        <p>Поточне фото:</p>
                        <img src="images/deserts/<?php echo $desert_id; ?>.jpg" alt="<?php echo htmlspecialchars($desert['nazva']); ?>" class="current-image">
                    </div>
                <?php endif; ?>
            </div>
