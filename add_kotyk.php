...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($imya)) {
        ...
        $kotyk_id = addKotyk($imya, $vik, $stat, $poroda, $harakterystyka, $kav_yarnya_id);
        ...
        if ($kotyk_id) {
            ...
            $error = 'Помилка при додаванні котика';
        }
    }
}
?>
...
<head>
    ...
    <title>Додати нового котика - KityKoffe</title>
...
<body>
    ...
    <div class="form-container">
        <h1>Додати нового котика</h1>
        
        <p>
            <a href="admin.php?section=kotyky" class="btn">← Повернутися до списку</a>
        </p>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="stat" name="stat" required>
                    ...
                    <option value="Чоловіча" <?php echo (isset($_POST['stat']) && $_POST['stat'] == 'Чоловіча') ? 'selected' : ''; ?>>Чоловіча</option>
                    <option value="Жіноча" <?php echo (isset($_POST['stat']) && $_POST['stat'] == 'Жіноча') ? 'selected' : ''; ?>>Жіноча</option>
                </select>
            </div>
            ...
            <div class="btn-container">
                <button type="submit" class="btn">Додати котика</button>
            </div>
        </form>
    </div>
